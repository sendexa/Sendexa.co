      ...
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Pay only for what you use with transparent per-email pricing. Volume discounts available.
          </p>
        </motion.div>
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                {plan.price !== "Custom" && (
                  <div className="text-sm text-gray-400 mb-6">then ${plan.name === "Starter" ? "0.80" : "0.65"}/1000 emails</div>
                )}
                <p className="text-gray-400 mb-6">{plan.description}</p>
                <button className={`w-full py-3 rounded-lg font-medium mb-8 transition-colors ${plan.popular ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-800 hover:bg-gray-700'}`}>
                  {plan.cta}
                </button>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 mb-6 md:mb-0">
              ...
              <p className="text-gray-400">
                Our team can design a custom email infrastructure solution tailored to your specific requirements and volume needs.
              </p>
            </div>
