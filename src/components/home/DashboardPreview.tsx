...
const dashboardCards = [
  {
    ...
    gradient: "from-[#a6953f] to-[#d4b848]"
  },
  {
  ...
  },
  {
    ...
    image: "/images/011.png",
    gradient: "from-[#a6953f] to-[#c0aa4a]"
  },
];
    ...
    <Container>
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-100 mb-4">
          Your <span className="text-[#a6953f] font-extrabold">Smart Business Console</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {dashboardCards.map((card, idx) => (
          <div
            key={idx}
            className="relative rounded-3xl bg-gray-900/80 backdrop-blur-lg border-2 border-[#a6953f]/30 shadow-xl p-8 min-h-[580px] flex flex-col hover:border-[#a6953f] transition-all duration-300 group overflow-hidden"
          >
            <div className="absolute inset-0" />
            <div className="relative z-10 flex flex-col items-center w-full pb-44">
              <h3 className="text-2xl font-bold mb-3 text-center text-[#a6953f]">
                {card.title}
              </h3>
            ...
            <div className="absolute top-0 right-0 w-16 h-16 border-t-2 border-r-2 border-[#a6953f]/60 rounded-tr-3xl opacity-100 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>
        ))}
      </div>
