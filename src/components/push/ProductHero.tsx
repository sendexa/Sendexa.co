      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="md:w-1/2 order-2 md:order-1">
            ...
            >
              Drive 3x more engagement with our intelligent push notification
              platform. Perfect timing, precision targeting, and unmatched
              deliverability.
            </motion.p>
            ...
            >
              <button 
              onClick={() => window.open(`https://developers.sendexa.co/docs/api-keys`, '_blank')}
              className="px-6 py-3 md:px-8 md:py-4 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition-colors text-base md:text-lg shadow-lg hover:shadow-purple-600/20 flex items-center">
                <Code className="w-5 h-5 mr-2" />
                Get API Keys
              </button>
              <button 
              onClick={() => window.open(`https://developers.sendexa.co/docs/push-notifications`, '_blank')}
              className="px-6 py-3 md:px-8 md:py-4 border border-purple-400 text-purple-100 hover:bg-purple-900/50 rounded-lg font-medium transition-colors text-base md:text-lg">
                View Documentation
              </button>
              <button 
              onClick={() => window.open(`/contact`, '_blank')}
              className="px-6 py-3 md:px-8 md:py-4 text-purple-100 hover:text-white hover:bg-purple-900/30 rounded-lg font-medium transition-colors text-base md:text-lg">
                Talk to Sales
              </button>
            </motion.div>
            ...
            >
              ...
              >
                <div className="text-purple-400 text-sm font-mono">
                  <span className="text-gray-400">import</span> Notify{" "}
                  <span className="text-gray-400">from</span>{" "}
                  <span className="text-purple-300">&apos;push-sdk&apos;</span>
                  <br />
                  <br />
                  <span className="text-gray-400">await</span> Notify.send(
                  <span className="text-yellow-300">{"{"}</span>
                  <br />
                  <span className="text-blue-300 ml-4">to</span>:{" "}
                  ...
                  ,<br />
                  <span className="text-blue-300 ml-4">body</span>:{" "}
                  <span className="text-green-300">
                    &apos;Track your package here&apos;
                  </span>
                  ,<br />
                  <span className="text-blue-300 ml-4">data</span>:{" "}
                  <span className="text-yellow-300">{"{"}</span>{" "}
