      ...
      <Container>
        <div className="pt-8 pb-8">
            ...
            >
              ...
              >
                {socialLinks.map((social) => (
                  ...
                  >
                    <social.icon className="h-5 w-5 text-gray-300 hover:text-[#00c2c8] transition-colors" />
                  </motion.a>
                ))}
              </motion.div>
            </motion.div>
                  ...
                  <ul className="space-y-3">
                    {section.links.map((link) => (
                      <li key={link.name}>
                        <Link
                          href={link.href}
                          className="text-sm text-gray-400 hover:text-[#00c2c8] transition-colors flex items-center group"
                        >
                          <motion.span
                            whileHover={{ x: 5, color: "#00c2c8" }}
                          ...
                          >
                            ...
                            <motion.span
                              ...
                              className="block h-px bg-blue-text-[#00c2c8]"
                            />
                          </motion.span>
                        </Link>
                      </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            >
              &copy; {currentYear}{" "}
              <span className="font-medium text-[#00c2c8] transition-colors duration-300 underline-offset-2">
                Sendexa, LLC.
              </span>
              . All rights reserved.
            </motion.p>
            ...
            >
              <p className="transition-all duration-300">
                ...
                <span className="font-medium text-[#00c2c8] group-hover:text-yellow-500 transition-colors duration-300">
                  Xtottel Ltd
                </span>
              </p>
            </motion.div>
